  ...
  return (
    <div className="flex justify-center items-center bg-black bg-opacity-60 border-stone-800 border-4 rounded-xl mt-8 ">
      <div className="py-16 px-20 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <div className="mb-4">
          <h2 className="text-2xl mb-2 leading-relaxed">
            Username: {username}
          </h2>
          ...
          {showUsernameInput ? (
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="bg-blue-500 text-white p-2 my-1.5 leading-relaxed rounded-lg"
              >
                Save
              </button>
            </div>
          ...
          {showPasswordInput ? (
            <div className="flex items-center text-black space-x-2">
              ...
              <button
                ...
                className="bg-blue-500 text-white my-1.5 leading-relaxed p-2 rounded-lg"
              >
                Save
              </button>
            </div>
        ...
        <div className="mb-4">
          ...
          <button
            ...
            className="bg-red-500 mt-2 text-xl leading-relaxed text-white p-2 rounded-lg"
          >
            Delete Account
          </button>
        </div>
